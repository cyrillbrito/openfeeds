...
export interface CreateAuthOptions {
  /** Appended last to the plugins array. Used by web for `tanstackStartCookies()`. */
  extraPlugins?: BetterAuthPlugin[];
}

/** Shared Better Auth instance. Apps inject framework-specific cookie plugins via `extraPlugins`. */
export function createAuth(options: CreateAuthOptions = {}) {
  ...
  return betterAuth({
    ...
    plugins: [
      ...
      // Extra plugins must come last (Better Auth requirement).
      ...extraPlugins,
    ],
  });
}
