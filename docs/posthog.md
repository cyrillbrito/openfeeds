...
| `auth:login_view`       | `source`, `reason`, `context?`    | `apps/web/src/routes/login.tsx`, `collection-errors.ts` |
| `auth:login_fail`       | `source`, `code`, `message`       | `apps/web/src/routes/login.tsx`                      |
| `auth:session_fail`     | `source`, `context`, `status`     | `apps/web/src/lib/collection-errors.ts`              |
| `sync:shape_fail`       | `context`, `retry_count`, `message` | `apps/web/src/lib/collection-errors.ts`            |
