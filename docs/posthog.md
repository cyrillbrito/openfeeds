...
| `limits:extractions_limit_hit`    | `window`, `current_usage`, `limit`, `plan`          | `packages/domain/src/limits.ts`                                         |
| `limits:tts_limit_hit`            | `window`, `current_usage`, `limit`, `plan`          | `packages/domain/src/limits.ts`                                         |
