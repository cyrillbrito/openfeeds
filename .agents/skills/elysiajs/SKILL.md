---
name: elysiajs
description: "ElysiaJS backend development — routing, TypeBox validation, auth (JWT/Bearer/macros/guards), plugins (CORS, OpenAPI, static), WebSockets, Eden Treaty, and integrations (Drizzle, Better Auth). Use when creating or modifying Elysia servers, routes, handlers, or related backend code."
