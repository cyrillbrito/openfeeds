...
function LoginPage() {
  ...
  const handleLogin = async (e: Event) => {
    ...
    try {
      ...
      // Seed the session cache so the next guard run (inside the redirect
      // navigation below) doesn't refetch. PostHog identify is wired
      // reactively in _frame.tsx via useSession().
