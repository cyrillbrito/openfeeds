...
export function ArticleListToolbar(props: ArticleListToolbarProps) {
  ...
  return (
    <div class="mb-4">
      <div class="mx-auto flex w-full max-w-2xl items-center justify-between gap-3 px-4 sm:px-6 xl:max-w-3xl">
      ...
      <div class="mx-auto w-full max-w-2xl px-4 sm:px-6 xl:max-w-3xl">
